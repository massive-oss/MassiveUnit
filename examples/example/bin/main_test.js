...
massive.munit.UnhandledException = function(message,info) { if( message === $_ ) return; {
	...
	this.type = massive.haxe.util.ReflectUtil.here({ fileName : "UnhandledException.hx", lineNumber : 46, className : "massive.munit.UnhandledException", methodName : "new"}).className;
}}
...
massive.munit.TestRunner.prototype.set_asyncFactory = function(value) {
	...
	if(this.running) throw new massive.munit.MUnitException("Can't change AsyncFactory while tests are running",{ fileName : "TestRunner.hx", lineNumber : 116, className : "massive.munit.TestRunner", methodName : "set_asyncFactory"});
	value.observer = this;
...
massive.munit.client.PrintClient.prototype.init = function() {
	...
	if(this.textArea == null) {
		var positionInfo = massive.haxe.util.ReflectUtil.here({ fileName : "PrintClient.hx", lineNumber : 139, className : "massive.munit.client.PrintClient", methodName : "init"});
